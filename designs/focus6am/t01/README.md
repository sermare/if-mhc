# Inverse-folding epitope designs -- focus6am, T=0.1

159,808 designed epitope sequences over 2 pMHC-TCR complexes.
...
|---|---|---|---|---|
| `esmif.csv.gz` | esmif | both | 40,000 | 0.1 MB |
| `proteinmpnn.csv.gz` | proteinmpnn | both | 39,936 | 0.3 MB |
| `proteinmpnn_nomhc.csv.gz` | proteinmpnn_nomhc | both | 39,936 | 0.3 MB |
| `ligandmpnn.csv.gz` | ligandmpnn | both | 39,936 | 0.2 MB |
...
Regenerate with `py/skempi_package.py --dataset focus6am --temp 0.1`.
