# Inverse-folding epitope designs -- skempi, T=0.1

2,167,424 designed epitope sequences over 28 pMHC-TCR complexes.
...
|---|---|---|---|---|
| `esmif.csv.gz` | esmif | both | 560,000 | 1.8 MB |
| `proteinmpnn.csv.gz` | proteinmpnn | both | 559,104 | 4.8 MB |
| `proteinmpnn_nomhc.csv.gz` | proteinmpnn_nomhc | both | 559,104 | 4.8 MB |
| `ligandmpnn.csv.gz` | ligandmpnn | both | 489,216 | 3.1 MB |
...
Regenerate with `py/skempi_package.py --dataset skempi --temp 0.1`.
