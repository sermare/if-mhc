#!/usr/bin/env python3
"""Same as mhcflurry_score.py but for the mhconly peptide set. Run in the mhcflurry conda env.

Usage: /home/ubuntu/miniforge3/envs/mhcflurry/bin/python3 py/mhcflurry_score_mhconly.py
"""
...
out = OUT_DIR / "panel_unique_peptides_mhcflurry_mhconly.csv"
