#!/usr/bin/env python3
"""Same as esmcba_score.py but for the mhconly peptide set. Run in the esmcba conda env.

Usage: /home/ubuntu/miniforge3/envs/esmcba/bin/python3 py/esmcba_score_mhconly.py
"""
import glob
...
peptides = [l.strip() for l in open(OUT_DIR / "panel_unique_peptides_for_scoring_mhconly.txt") if l.strip()]
...
emb_path = OUT_DIR / "panel_unique_peptides_esmcba_embeddings_mhconly.npy"
...
out = OUT_DIR / "panel_unique_peptides_esmcba_mhconly.csv"
