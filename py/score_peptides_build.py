...
T.to_csv(f"{ROOT}/outputs/skempi_if/peptides_to_score{SUF}.csv", index=False)

pairs = T[["seq", "mhcflurry_allele"]].drop_duplicates()
pairs.to_csv(f"{ROOT}/outputs/skempi_if/mhcflurry_input_pairs{SUF}.csv", index=False)
